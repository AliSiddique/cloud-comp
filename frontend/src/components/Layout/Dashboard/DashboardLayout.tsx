                  ...
                  <form className="flex w-full md:ml-0" action="#" method="GET">
                    ...
                    <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                      ...
                      <input
                        ...
                        className="h-full w-full border-0 py-2 pl-8 pr-3 bg-white text-base text-gray-900 focus:outline-none focus:ring-0 focus:placeholder:text-gray-400 sm:hidden"
                        placeholder="Search"
                        type="search"
                      />
                      <input
                        ...
                        className="hidden h-full w-full border-0 py-2 bg-white pl-8 pr-3 text-sm text-gray-900 focus:outline-none focus:ring-0 focus:placeholder:text-gray-400 sm:block"
                  ...
                  <dl className="mt-2 divide-y divide-gray-200 border-b border-t border-gray-200">
                    {Object.keys(currentFile.information).map((key) => (
                      <div key={key} className="flex justify-between py-3 text-sm font-medium">
                        ...
                        <dd className="whitespace-nowrap text-gray-900"></dd>
                      </div>
                    ))}
                  </dl>
                </div>
